package com.redsifter.score.utils;
...
public class FileManager {
    ...
    public void reloadConfig() throws FileNotFoundException {
        if (this.configFile == null) {
            this.configFile = new File ("plugins/Score/", this.name);
        }
        this.dataConfig= YamlConfiguration.loadConfiguration(this.configFile);
        FileInputStream defaultStream = new FileInputStream("plugins/Score/"+this.name);
